...
class BOQInspection(models.Model):
    ...
    inspected_unit_rate = models.DecimalField(max_digits=15, decimal_places=2)

    inspected_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0)

    def save(self, *args, **kwargs):
        self.inspected_amount = self.inspected_quantity * self.inspected_unit_rate
        super().save(*args, **kwargs)
# --------------------------------------------------------
